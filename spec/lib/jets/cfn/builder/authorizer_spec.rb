describe Jets::Cfn::Builder::Authorizer do
  let(:builder) do
    Jets::Cfn::Builder::Authorizer.new(path)
  end
  ...
  context "MainAuthorizer" do
    ...
    describe "compose" do
      it "builds a child stack with controller resources" do
        ...
        expect(builder.template_path).to eq "#{Jets.build_root}/templates/authorizers-main_authorizer.yml"
      end
    end
  end
end
