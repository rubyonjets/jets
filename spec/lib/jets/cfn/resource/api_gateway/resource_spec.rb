describe Jets::Cfn::Resource::ApiGateway::Resource do
  let(:resource) { Jets::Cfn::Resource::ApiGateway::Resource.new(path) }
  ...
  #     resource = Jets::Cfn::Resource::ApiGateway::Resource.new(route.path)
