describe Jets::Cfn::Resource::ApiGateway::RestApi::Routes::Change::To do
  let(:to) do
    Jets::Cfn::Resource::ApiGateway::RestApi::Routes::Change::To.new
  end
  ...
  context "yes changes detected" do
    it "changed" do
      ...
      new_routes[0] = Jets::Router::Route.new(:path=>"/", :to=>"toys#index", :http_method=>:get, :root=>true)
