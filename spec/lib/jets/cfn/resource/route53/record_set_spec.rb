describe Jets::Cfn::Resource::Route53::RecordSet do

  context 'default' do
    let(:record_set) do
      Jets::Cfn::Resource::Route53::RecordSet.new
    end
    ...
    it "record_set" do
      ...
      allow(Jets::Cfn::Resource::ApiGateway::RestApi).to receive(:internal_logical_id).and_return("fakerestapi")
