...
* Find [an open issue](https://github.com/tongueroo/jets/issues) (especially [those labeled `help-wanted`](https://github.com/tongueroo/jets/issues?q=is%3Aopen+is%3Aissue+label%3Ahelp-wanted)), and submit a proposed fix. If it's your first pull request, we promise we won't bite, and are glad to answer any questions.
