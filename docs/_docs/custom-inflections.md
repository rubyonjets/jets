...
Jets look ups folders, files, and classes based on naming conventions. It singuarlizes or pluralizes works as a part of this naming convention. For example
