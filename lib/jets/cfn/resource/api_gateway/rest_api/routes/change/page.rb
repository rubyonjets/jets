class Jets::Cfn::Resource::ApiGateway::RestApi::Routes::Change
  class Page < Base
    ...
    def local_logical_ids_map(path_expression="#{Jets::Names.templates_folder}/api-resources-*.yml")
    ...
    def remote_logical_ids_map
      ...
      parent_resources.each do |resource|
        ...
        regexp = Regexp.new("#{Jets.project_namespace}-ApiResources(\\d+)-") # tricky to escape \d pattern
