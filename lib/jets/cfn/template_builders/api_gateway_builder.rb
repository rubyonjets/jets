class Jets::Cfn::TemplateBuilders
  class ApiGatewayBuilder
    ...
    def add_gateway_rest_api
      ...
      add_output("HomepageApiGatewayResource", Value: "!GetAtt RestApi.HomepageApiGatewayResource")
    end
    ...
    def add_gateway_routes
      ...
      Jets::Router.all_paths.each do |path|
        homepage = path == ''
        next if homepage # handled by HomepageApiGatewayResource output already
