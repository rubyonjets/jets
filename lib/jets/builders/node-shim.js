...
exports.<%= function_name %> = (event, context, callback) => {
  request(event, "<%= @vars.handler_for(function_name) %>", callback);
};
<% end %>

// exports.hi = (event, context, callback) => {
//   request(event, "handlers/controllers/hi_controller.hi", callback);
// };

// exports.process = (event, context, callback) => {
//   request(event, "handlers/controllers/jets/rack_controller.process", callback);
// };
...
if (require.main === module) {
  ...
  exports.<%= @vars.functions.first %>(event, context, (error, message) => {
  ...
  // var event = {"path": "/posts"};
  // var context = {"fake": "context"};
  // exports.process(event, context, (error, message) => {
  //   log("\nLOCAL TESTING OUTPUT");
  //   if (error) {
  //     console.log("error message: %o", error);
  //   } else {
