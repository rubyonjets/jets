...
// Produces an Error object that displays in the AWS Jetsbda test console nicely.
// The backtrace are the ruby lines, not the nodejs shim error lines.
// The json payload in the Jetsbda console looks something like this:
//
// {
...
module.exports.<%= function[:name] %> = (event, context, callback) => {
  ...
  // process.
  // The Jetsbda prints out function to whatever the return value the ruby method
